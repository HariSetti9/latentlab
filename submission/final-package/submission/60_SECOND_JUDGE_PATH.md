...
|---|---|---|
| 0-10 s | Open the [public depth-4 fixture](https://harisetti9.github.io/latentlab/?fixture=depth-matters-winding&depth=4). | A live preset is already computed; BFS says shortest distance 6 while the depth-limited estimate is incomplete. |
...
| 35-45 s | Compare `LIVE COMPUTATION - ALGORITHMIC TOY` with `INDEPENDENT BFS REFERENCE`. | Truth evaluates the recurrence but does not feed it. |
...
Next, open the public [Evidence section](https://harisetti9.github.io/latentlab/#evidence) for the sourced BDH/BDH-CQ connection and explicit non-equivalence warning.
