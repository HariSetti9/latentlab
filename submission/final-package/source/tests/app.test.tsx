...
describe('interactive learning experience', () => {
  ...
  it('labels the substrate as algorithmic rather than implying a learned model', () => {
    render(<App />);
    expect(screen.getByText('ALGORITHMIC TOY')).toBeVisible();
    expect(screen.queryByText('TOY MODEL')).not.toBeInTheDocument();
  });
