...
| 2:05-2:20 | "Everything important is reproducible: one command regenerates 80 item-level cases, verifies presets, runs 58 tests, builds, and checks evidence integrity." | Show README deliverables and `pnpm reproduce` command. | Judge paths and explicit pending publication/video links. |
