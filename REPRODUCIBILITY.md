...
Direct commands: `pnpm test`, `pnpm evaluate --write`, `pnpm verify:presets --write`, `pnpm checksums`, `pnpm check:citations`, `pnpm check:links`, `pnpm check:licenses`, `pnpm build`, `pnpm verify:pdfs`, and `pnpm verify:package`.
