    ...
    <>
      ...
      <main id="top">
        <section className="opening" id="experiment">
          <div className="opening-copy"><div className="eyebrow">A live, inspectable recurrence</div><h1>Can an AI compute longer <em>without talking longer?</em></h1><p>Change one number. Watch a fixed-size hidden state update before the system reads its answer.</p><div className="truth-labels"><span>LIVE COMPUTATION</span><span>TOY MODEL</span><span>NO GENERATED REASONING TEXT</span></div></div>
