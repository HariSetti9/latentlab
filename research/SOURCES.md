...
Last verified: 2026-09-07. “Author-reported” means the source's authors report the mechanism or result; it does not imply independent reproduction. Only claims listed under “Safe wording” may enter learner-facing copy before a later full-text audit expands this record.
...
- Exact support reviewed: arXiv abstract and metadata, especially abstract sentences 1-4
...
- Exact support reviewed: arXiv abstract, especially the method sentence describing feedback of the last hidden state as the next input embedding
...
- Exact support reviewed: arXiv abstract and metadata, especially abstract paragraphs describing locally interacting neuron particles, graph/GPU forms, and inference working memory
...
- Exact support reviewed: arXiv abstract and metadata, especially the mechanism sentence and evaluation description
...
- Before using detailed equations, architectural diagrams, section-level ablations, or benchmark tables, Phase 5 must audit the relevant full-text section and license. No source figure is currently approved for reuse.
- No independent reproduction of BDH or BDH-CQ has been verified. The application must label their evidence as published developer-reported evidence.
