...
| Craft, robustness, accessibility, provenance | 10 | Mobile/keyboard/reduced motion; clean load/error states; reproducibility; credits/licenses | `docs/ACCESSIBILITY.md`, `docs/qa/`, `REPRODUCIBILITY.md`, test/evidence matrices | IN PROGRESS: provenance and CI remain |
