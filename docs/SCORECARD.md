...
| Interactive substrate and honesty | 15 | Live iteration control, visible measured state, estimate beside truth, evidence labels, fast feedback | `src/core/`, unit tests, application, E2E tests, `docs/qa/` | IN PROGRESS |
